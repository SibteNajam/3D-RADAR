    ...
    <group>
      ...
      <group ref={cardGroupRef} position={[0, 2.8, 0]} scale={0.001}>
        ...
        <group ref={cardRotateRef}>
          ...
          <Text position={[0, H/2 - 0.015, 0.005]} fontSize={0.03} color="#ffffff66" anchorX="center" anchorY="middle" letterSpacing={0.4}>
            ⋯ DRAG TO MOVE ⋯
          </Text>
          ...
          {/* Confidence */}
          <Text position={[-W/2 + 0.25, H/2 - 1.15, 0.005]} fontSize={0.055} color="#ffffff55" anchorX="left" anchorY="top" letterSpacing={0.12}>CONF</Text>
          ...
          {/* Volume */}
          <Text position={[-0.05, H/2 - 1.15, 0.005]} fontSize={0.055} color="#ffffff55" anchorX="left" anchorY="top" letterSpacing={0.12}>VOL</Text>
          <Text position={[-0.05, H/2 - 1.28, 0.005]} fontSize={0.11} color="#ffffff" anchorX="left" anchorY="top" fontWeight={700}>{data.vol || '—'}</Text>

          {/* Signal ID */}
          <Text position={[W/2 - 0.7, H/2 - 1.15, 0.005]} fontSize={0.055} color="#ffffff55" anchorX="left" anchorY="top" letterSpacing={0.12}>SIG</Text>
          ...
          <Text position={[-W/2 + 0.22, H/2 - 1.74, 0.005]} fontSize={0.065} color="#ffffff88" anchorX="left" anchorY="top" maxWidth={W - 0.5} lineHeight={1.4}>
            {data.desc || 'Signal analysis pending...'}
          </Text>

          {/* Rotate hint at bottom */}
          <Text position={[0, -H/2 + 0.46, 0.005]} fontSize={0.03} color="#ffffff33" anchorX="center" anchorY="middle" letterSpacing={0.3}>
            ⟳ DRAG CARD TO ROTATE
          </Text>
          ...
          <Text position={[0.45, -H/2 + 0.2, 0.005]} fontSize={0.06} color="#ffffff77" anchorX="center" anchorY="middle" letterSpacing={0.1}>◇ WATCH</Text>
        </group>
      </group>
    </group>
  )
...
function ExplodedDotView({ data, colorPair, explodeValue, controlsRef }) {
  ...
  const labels = useMemo(() => [
    ...
    { text: 'VOL ' + (data.vol || '—'), color: '#ffffff88', y: -0.15 },
