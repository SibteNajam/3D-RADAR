...
export default function RadarCard2D({ onClick }) {
...
// Popup spawn — exactly matches your original code
function spawnPopup(sig, W, H, ui, st) {
  ...
  setTimeout(() => {
    const bar = el.querySelector('[data-w]')
